<!--
Source: https://github.com/curl/curl/blob/master/docs/tests/TEST-SUITE.md (retrieved 2026-06-10)
Why mimic: curl's in-repo test-suite README. Names its three test KINDS (cli tool /
library / unit), explains test numbering, memory + coverage runs, and "how to write a
test". Good model for a CLI+library project's tests/README. Verbatim upstream copy below.
NOTE: the per-test-case file format it references lives in curl-FILEFORMAT.md (this folder).
-->
