"""Solved-schedule fixtures for the fixed-matchup (old) scheduler."""

from __future__ import annotations

import pytest

from athc.scheduler.schedulers.types import FIXED_MATCHUP_SCHEDULER, SchedulerResult
...
def scheduler_result(league, tmp_path_factory) -> SchedulerResult:
    return solve_and_report(league, FIXED_MATCHUP_SCHEDULER, tmp_path_factory)
