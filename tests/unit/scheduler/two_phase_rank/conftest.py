"""Solved-schedule fixtures for Scheduler B (full CP-SAT)."""

from __future__ import annotations

import pytest

from athc.scheduler.schedulers.types import SCHEDULER_B, SchedulerResult
...
def scheduler_result(league, tmp_path_factory) -> SchedulerResult:
    return solve_and_report(league, SCHEDULER_B, tmp_path_factory)
