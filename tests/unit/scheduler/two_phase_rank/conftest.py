"""Solved-schedule fixtures for the two-phase-rank (new) scheduler."""

from __future__ import annotations

import pytest

from athc.scheduler.schedulers.types import DEFAULT_SCHEDULER, SchedulerResult
...
def scheduler_result(league, tmp_path_factory) -> SchedulerResult:
    return solve_and_report(league, DEFAULT_SCHEDULER, tmp_path_factory)
