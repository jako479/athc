...
DEFAULT_SCHEDULER = "two-phase-rank"
FIXED_MATCHUP_SCHEDULER = "fixed-matchup"

_SCHEDULER_NAMES = (DEFAULT_SCHEDULER, FIXED_MATCHUP_SCHEDULER)
...
def get_scheduler(name: str) -> SchedulerFunc:
    ...
    if name == FIXED_MATCHUP_SCHEDULER:
