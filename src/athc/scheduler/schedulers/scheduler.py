...
- Either 0 teams or exactly 2 teams may open the season with back-to-back divisional
  games.
- No 3 straight divisional games to start or end the season.
- At most 1 total 3-game divisional streak per team.
- 5-team divisions: max 7 divisional games in any 10-game span and no 7 in any 9-game
  span.
- 4-team divisions: max 5 divisional games in any 8-game span and no 4 in any 7-game
  span.
- At least half of each team's divisional games must occur in the second half of the
  season.
- At most 2 divisional opponents may be non-interleaved between a team's 2 meetings with
  that rival.
